...
Once the `conda-forge` channel has been enabled, `psycopg, psycopg-c` can be installed with:

```
conda install psycopg psycopg-c
```

It is possible to list all of the versions of `psycopg` available on your platform with:
